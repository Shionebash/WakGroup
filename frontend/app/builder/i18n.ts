...
const builderCopy = {
    ...
    minLevel: text('Nivel minimo', 'Min level', 'Niveau min', 'Nivel minimo'),
    maxLevel: text('Nivel maximo', 'Max level', 'Niveau max', 'Nivel maximo'),
    minLevelAny: text('Sin minimo', 'No minimum', 'Sans minimum', 'Sem minimo'),
    maxLevelAny: text('Sin maximo', 'No maximum', 'Sans maximum', 'Sem maximo'),
    class: text('Clase', 'Class', 'Classe', 'Classe'),
    search: text('Buscar', 'Search', 'Rechercher', 'Buscar'),
    filters: text('Filtros', 'Filters', 'Filtres', 'Filtros'),
    close: text('Cerrar', 'Close', 'Fermer', 'Fechar'),
    identicalStats: text('Stats identicos', 'Identical stats', 'Stats identiques', 'Stats identicos'),
    ...
    statSort: text('Orden de stat', 'Stat order', 'Ordre de stat', 'Ordem da stat'),
    statSortDesc: text('Mayor a menor', 'Highest to lowest', 'Plus grand au plus petit', 'Maior para menor'),
    statSortAsc: text('Menor a mayor', 'Lowest to highest', 'Plus petit au plus grand', 'Menor para maior'),
    ...
    compare: text('Comparación', 'Comparison', 'Comparaison', 'Comparação'),
    compareClose: text('Dejar de comparar', 'Stop comparing', 'Arrêter la comparaison', 'Parar comparação'),
    compareEmpty: text('Selecciona una pieza del catálogo para compararla con la equipada.', 'Select an item from the catalog to compare it with the equipped one.', 'Sélectionnez une pièce du catalogue pour la comparer à celle équipée.', 'Selecione uma peça do catálogo para compará-la com a equipada.'),
    compareNoEquipped: text('No hay item equipado en este slot. La comparación se hace contra vacío.', 'There is no item equipped in this slot. The comparison is against empty.', 'Aucun objet n’est équipé dans cet emplacement. La comparaison se fait contre le vide.', 'Não há item equipado neste slot. A comparação é contra o vazio.'),
    compareSame: text('Esta pieza ya está equipada en el slot activo.', 'This item is already equipped in the active slot.', 'Cette pièce est déjà équipée dans l’emplacement actif.', 'Esta peça já está equipada no slot ativo.'),
    ...
    itemMasteryTotal: text('Total dominios', 'Total mastery', 'Total maitrises', 'Total dominios'),
    itemResistanceTotal: text('Total resis', 'Total resistances', 'Total resistances', 'Total resistencias'),
    itemFocusStat: text('Stat filtrada', 'Filtered stat', 'Stat filtree', 'Stat filtrada'),
    itemDetailsTitle: text('Detalle del equipo', 'Item details', 'Details de l equipement', 'Detalhes do equipamento'),
    itemExpandDetails: text('Clic para ver detalle completo', 'Click to view full details', 'Cliquez pour voir le detail complet', 'Clique para ver os detalhes completos'),
    itemCollapseDetails: text('Clic para ocultar detalle', 'Click to hide details', 'Cliquez pour masquer les details', 'Clique para ocultar os detalhes'),
