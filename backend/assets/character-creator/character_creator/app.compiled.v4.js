...
const localizedText = (value, language = "es", fallback = "") => {
  ...
  const fallbackText = typeof fallback === "string" ? fallback : fallback?.[lang] || fallback?.es || fallback?.en || fallback?.fr || fallback?.pt || "";
...
function CharacterCreator() {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "cc-page", "data-screen-label": "01 Creador de personaje" }, /* @__PURE__ */ React.createElement("div", { className: "cc-layout" }, /* @__PURE__ */ React.createElement("div", { className: "cc-panel" }, /* @__PURE__ */ React.createElement("div", { className: "cc-panel-head" }, /* @__PURE__ */ React.createElement("div", { className: "cc-panel-eyebrow" }, /* @__PURE__ */ React.createElement("span", { className: "cc-panel-eyebrow-num" }, "I"), /* @__PURE__ */ React.createElement("span", { className: "cc-panel-eyebrow-label" }, copy.classEyebrow)), /* @__PURE__ */ React.createElement("span", { className: "cc-panel-title" }, copy.classTitle)), /* @__PURE__ */ React.createElement("div", { className: "cc-panel-body" }, /* @__PURE__ */ React.createElement("div", { className: "cc-class-grid" }, CLASSES.map((c) => {
    ...
    copy.removeCostume
  )), !classSupportsAdvancedCustomization && /* @__PURE__ */ React.createElement("div", { className: "cc-inline-note" }, copy.noAdvancedWardrobe), activeSharedCostume && /* @__PURE__ */ React.createElement("div", { className: "cc-shared-costume-meta" }, /* @__PURE__ */ React.createElement("strong", null, activeSharedCostume.sourceLabel ? repairMojibake(activeSharedCostume.sourceLabel) : localizedText(activeSharedCostume.label, language)), /* @__PURE__ */ React.createElement("span", null, activeSharedCostume.components.length, " ", activeSharedCostume.components.length !== 1 ? copy.components : copy.component, activeSharedCostume.itemId ? ` \xB7 item #${activeSharedCostume.itemId}` : ` \xB7 ${activeSharedCostume.components[0]?.appearanceId}`))), [
