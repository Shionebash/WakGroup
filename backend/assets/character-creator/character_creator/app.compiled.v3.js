...
function Icon({ name, ...rest }) {
  return /* @__PURE__ */ React.createElement("span", { ...rest, dangerouslySetInnerHTML: { __html: Icons[name] || "" } });
}
const BG_OPTIONS = [
  { id: "void", label: { es: "Vacio", en: "Void", fr: "Vide", pt: "Vazio" } },
  { id: "sanctum", label: { es: "Sanctum", en: "Sanctum", fr: "Sanctuaire", pt: "Santu\xE1rio" } },
  { id: "forest", label: { es: "Bosque", en: "Forest", fr: "For\xEAt", pt: "Bosque" } },
...
const CC_COPY = {
  es: {
    classEyebrow: "Clase",
    classTitle: "Senda",
    classSearch: "Buscar por nombre o rol...",
    avatarEyebrow: "Tu Avatar",
    unnamed: "Sin nombre",
    noNameHero: "Heroe sin nombre",
    random: "Aleatorio",
    reset: "Restaurar",
    savePng: "Guardar PNG",
    levelHero: "Lv 1 \xB7 Heroe",
    rotateLeft: "Girar izquierda",
    resetRotation: "Reiniciar",
    ...
    costume: "Traje",
    noCostume: "Sin traje",
    classBase: "Base de clase",
    activePalette: "Paleta activa",
    baseClothes: "Vestimenta base de la clase activa.",
    liveBase: "Render base vivo para esta clase y genero.",
    appearance: "Apariencia",
    customize: "Personalizar",
    identity: "Identidad",
    heroName: "Nombre del heroe",
    heroNamePlaceholder: "Escribe un nombre epico...",
    gender: "Genero",
    female: "Femenino",
    male: "Masculino",
    animation: "Animacion",
    ...
    wardrobe: "Vestimenta",
    armorModel: "Modelo de armadura",
    noOutfits: "No encontre una familia de vestimentas emparejada para esta clase en los assets publicados.",
    available: "Disponibles",
    status: "Estado",
    fullView: "Vista completa",
    noHelmet: "Sin casco",
    withHelmet: "Con casco",
    openWardrobe: "Abrir vestidor",
    removeCostume: "Quitar traje",
    noAdvancedWardrobe: "Esta clase usa su base real y por ahora no comparte el navegador avanzado de trajes del creador.",
    components: "componentes",
    component: "componente",
    noEffect: "sin efecto",
    noEffectTitle: "Este canal no afecta al traje activo",
    channel1: "Canal 1 - Tejido base",
    channel2: "Canal 2 - Secundario",
    channel3: "Canal 3 - Metalico",
    channel4: "Canal 4 - Detalle A",
    channel5: "Canal 5 - Detalle B",
    channel6: "Canal 6 - Sombra",
    auras: "Auras",
    equipmentAuras: "Auras de equipo",
    noAura: "Ninguna",
    saveAppearance: "Guardar apariencia",
    wardrobeModal: "Vestidor",
    wardrobeOf: "Vestimenta de",
    closeWardrobe: "Cerrar vestidor",
    catalog: "catalogo",
    searchCostume: "Buscar traje...",
    externalNoCostume: "Sin traje externo",
    visualEquipment: "Equipamiento visual",
    visual: "Visual",
    ...
    noCharacterExport: "No hay personaje para exportar.",
    pngCreateError: "No se pudo crear el PNG.",
    pngExportError: "No se pudo exportar el PNG.",
    appearanceLoaded: "Apariencia cargada desde WakGroup.",
    appearanceSaved: "Apariencia guardada.",
    appearanceSaveError: "No se pudo guardar la apariencia.",
    savingAppearance: "Guardando apariencia...",
    element_fire: "Fuego",
    element_water: "Agua",
  ...
  en: {
    classEyebrow: "Class",
    classTitle: "Path",
    classSearch: "Search by name or role...",
    avatarEyebrow: "Your Avatar",
    unnamed: "Unnamed",
    noNameHero: "Unnamed hero",
    random: "Random",
    reset: "Reset",
    savePng: "Save PNG",
    levelHero: "Lv 1 \xB7 Hero",
    ...
    baseClothes: "Base outfit for the active class.",
    liveBase: "Live base render for this class and gender.",
    appearance: "Appearance",
    customize: "Customize",
    identity: "Identity",
    heroName: "Hero name",
    heroNamePlaceholder: "Type an epic name...",
    gender: "Gender",
    female: "Female",
    male: "Male",
    animation: "Animation",
    ...
    noOutfits: "No matching outfit family was found for this class in the published assets.",
    available: "Available",
    status: "Status",
    fullView: "Full view",
    noHelmet: "No helmet",
    ...
    noAdvancedWardrobe: "This class uses its real base and does not yet share the advanced costume browser.",
    components: "components",
    component: "component",
    noEffect: "no effect",
    noEffectTitle: "This channel does not affect the active costume",
    channel1: "Channel 1 - Base fabric",
    channel2: "Channel 2 - Secondary",
    channel3: "Channel 3 - Metal",
    channel4: "Channel 4 - Detail A",
    channel5: "Channel 5 - Detail B",
    channel6: "Channel 6 - Shadow",
    auras: "Auras",
    equipmentAuras: "Equipment auras",
    noAura: "None",
    saveAppearance: "Save appearance",
    wardrobeModal: "Wardrobe",
    wardrobeOf: "Wardrobe for",
    closeWardrobe: "Close wardrobe",
    catalog: "catalog",
    searchCostume: "Search costume...",
    externalNoCostume: "No external costume",
    visualEquipment: "Visual equipment",
    visual: "Visual",
    equipment: "Equipment",
    none: "None",
    ...
    pngSaved: "PNG saved.",
    noCharacterExport: "No character to export.",
    pngCreateError: "Could not create PNG.",
    pngExportError: "Could not export PNG.",
    appearanceLoaded: "Appearance loaded from WakGroup.",
    appearanceSaved: "Appearance saved.",
    appearanceSaveError: "Could not save appearance.",
  ...
  fr: {
    classEyebrow: "Classe",
    classTitle: "Voie",
    classSearch: "Rechercher par nom ou role...",
    avatarEyebrow: "Ton avatar",
    unnamed: "Sans nom",
    noNameHero: "Heros sans nom",
    random: "Aleatoire",
    reset: "Reinitialiser",
    savePng: "Enregistrer PNG",
    levelHero: "Niv. 1 \xB7 Heros",
    rotateLeft: "Tourner a gauche",
    resetRotation: "Reinitialiser",
    ...
    armor: "Armure",
    costume: "Costume",
    noCostume: "Sans costume",
    classBase: "Base de classe",
    activePalette: "Palette active",
    baseClothes: "Tenue de base de la classe active.",
    liveBase: "Rendu de base pour cette classe et ce genre.",
    appearance: "Apparence",
    customize: "Personnaliser",
    identity: "Identite",
    heroName: "Nom du heros",
    heroNamePlaceholder: "Ecris un nom epique...",
    gender: "Genre",
    female: "Feminin",
    male: "Masculin",
    animation: "Animation",
    ...
    wardrobe: "Tenue",
    armorModel: "Modele d armure",
    noOutfits: "Aucune famille de tenue associee trouvee pour cette classe.",
    available: "Disponibles",
    status: "Etat",
    fullView: "Vue complete",
    noHelmet: "Sans casque",
    withHelmet: "Avec casque",
    openWardrobe: "Ouvrir le vestiaire",
    removeCostume: "Retirer le costume",
    noAdvancedWardrobe: "Cette classe utilise sa base reelle et ne partage pas encore le navigateur avance.",
    components: "composants",
    component: "composant",
    noEffect: "sans effet",
    noEffectTitle: "Ce canal n affecte pas le costume actif",
    channel1: "Canal 1 - Tissu base",
    channel2: "Canal 2 - Secondaire",
    channel3: "Canal 3 - Metal",
    channel4: "Canal 4 - Detail A",
    channel5: "Canal 5 - Detail B",
    channel6: "Canal 6 - Ombre",
    auras: "Auras",
    equipmentAuras: "Auras d equipement",
    noAura: "Aucune",
    saveAppearance: "Enregistrer apparence",
    wardrobeModal: "Vestiaire",
    wardrobeOf: "Tenue de",
    closeWardrobe: "Fermer le vestiaire",
    catalog: "catalogue",
    searchCostume: "Rechercher costume...",
    externalNoCostume: "Sans costume externe",
    visualEquipment: "Equipement visuel",
    visual: "Visuel",
    ...
    noCharacterExport: "Aucun personnage a exporter.",
    pngCreateError: "Impossible de creer le PNG.",
    pngExportError: "Impossible d exporter le PNG.",
    appearanceLoaded: "Apparence chargee depuis WakGroup.",
    appearanceSaved: "Apparence enregistree.",
    appearanceSaveError: "Impossible d enregistrer l apparence.",
  ...
  pt: {
    classEyebrow: "Classe",
    classTitle: "Caminho",
    classSearch: "Buscar por nome ou funcao...",
    avatarEyebrow: "Seu Avatar",
    unnamed: "Sem nome",
    noNameHero: "Heroi sem nome",
    random: "Aleatorio",
    reset: "Restaurar",
    savePng: "Salvar PNG",
    levelHero: "Nv. 1 \xB7 Heroi",
    ...
    costume: "Traje",
    noCostume: "Sem traje",
    classBase: "Base da classe",
    activePalette: "Paleta ativa",
    baseClothes: "Roupa base da classe ativa.",
    liveBase: "Render base vivo para esta classe e genero.",
    appearance: "Aparencia",
    customize: "Personalizar",
    identity: "Identidade",
    heroName: "Nome do heroi",
    heroNamePlaceholder: "Digite um nome epico...",
    gender: "Genero",
    female: "Feminino",
    male: "Masculino",
    animation: "Animacao",
    ...
    wardrobe: "Vestu\xE1rio",
    armorModel: "Modelo de armadura",
    noOutfits: "Nao encontrei uma familia de roupas pareada para esta classe nos assets publicados.",
    available: "Disponiveis",
    status: "Estado",
    fullView: "Vista completa",
    noHelmet: "Sem capacete",
    withHelmet: "Com capacete",
    openWardrobe: "Abrir guarda-roupa",
    removeCostume: "Remover traje",
    noAdvancedWardrobe: "Esta classe usa sua base real e ainda nao compartilha o navegador avancado de trajes.",
    components: "componentes",
    component: "componente",
    noEffect: "sem efeito",
    noEffectTitle: "Este canal nao afeta o traje ativo",
    channel1: "Canal 1 - Tecido base",
    channel2: "Canal 2 - Secundario",
    channel3: "Canal 3 - Metal",
    channel4: "Canal 4 - Detalhe A",
    channel5: "Canal 5 - Detalhe B",
    channel6: "Canal 6 - Sombra",
    auras: "Auras",
    equipmentAuras: "Auras de equipamento",
    noAura: "Nenhuma",
    saveAppearance: "Salvar aparencia",
    wardrobeModal: "Guarda-roupa",
    wardrobeOf: "Vestu\xE1rio de",
    closeWardrobe: "Fechar guarda-roupa",
    catalog: "catalogo",
    searchCostume: "Buscar traje...",
    externalNoCostume: "Sem traje externo",
    visualEquipment: "Equipamento visual",
    visual: "Visual",
    ...
    preparingPng: "Preparando PNG...",
    pngSaved: "PNG salvo.",
    noCharacterExport: "Nao ha personagem para exportar.",
    pngCreateError: "Nao foi possivel criar o PNG.",
    pngExportError: "Nao foi possivel exportar o PNG.",
    appearanceLoaded: "Aparencia carregada do WakGroup.",
    appearanceSaved: "Aparencia salva.",
    appearanceSaveError: "Nao foi possivel salvar a aparencia.",
    savingAppearance: "Salvando aparencia...",
    element_fire: "Fogo",
    element_water: "Agua",
    element_earth: "Terra",
    element_air: "Ar",
...
const KNOWN_SHARED_PARTS = /* @__PURE__ */ new Set([
  "Chapeau",
  "Cape",
  "CapeBas",
  "CorpsHabit",
...
const WEAPON_STANCE_TYPE_IDS = /* @__PURE__ */ new Set([101, 108, 110, 111, 112, 113, 114, 115, 117, 219, 223, 253, 254]);
...
function ClassIcon({ classData, gender }) {
  return /* @__PURE__ */ React.createElement("span", { className: "cc-class-sigil", style: { color: classData.accent } }, /* @__PURE__ */ React.createElement("img", { src: classData.iconPath, alt: "", draggable: false }), /* @__PURE__ */ React.createElement("span", { className: "cc-class-gender-badge cc-class-gender-badge--" + gender }, genderBadge(gender)));
}
const buildSharedCostumeLayers = (sharedCostumeId, hideHelmet = false, gender = "female") => {
  ...
  if (!bundle) return [];
  const components = gender === "male" && bundle.maleComponents ? bundle.maleComponents : gender === "female" && bundle.femaleComponents ? bundle.femaleComponents : bundle.components;
  return components.map((component, index) => {
    ...
    const layer = {
      ...
      role: "equipment",
      isCostume: true
      // gates the helmet-fallback in _rebuildEquipmentOverrides
    };
...
const outfitForGender = (outfit, gender) => gender === "male" ? outfit?.maleEquipId : outfit?.femaleEquipId;
const buildManifest = (classData, state) => {
  ...
  if (classData.supportsAdvancedCustomization) {
    ...
    const hair = HAIRSTYLES.find((h) => h.id === state.hairStyleId && h.classId === hairClassId) || HAIRSTYLES.find((h) => h.classId === hairClassId) || null;
...
const DEFAULTS = {
  ...
  costume1: "#c9c7bd",
  // slot 10 â€” primary zone (+ slot 9 base fabric)
  costume2: "#2f7c84",
  // slot 11 â€” secondary zone
  costume3: "#c9c7bd",
  // slot 12 â€” tertiary / metal accents
  costume4: "#2f7c84",
  // slot 13 â€” detail A
  costume5: "#c9a514",
  // slot 14 â€” detail B
  costume6: "#4d8e8e",
  // slot 15 â€” dark / shadow zone
  symbolFg: "#f1c056",
  symbolBg: "#2a2014",
  name: "Aeliana",
  bg: "void"
...
function HexPicker({ value, onChange }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "cc-hex-picker" }, /* @__PURE__ */ React.createElement("label", { className: "cc-hex-swatch", style: { background: safe } }, /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "color",
      value: safe,
  ...
  )), /* @__PURE__ */ React.createElement("span", { className: "cc-hex-hash" }, "#"), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "text",
...
function EquipmentItemIcon({ item, label }) {
  ...
  if (!src || broken) {
    return /* @__PURE__ */ React.createElement("span", { className: "cc-equip-card-fallback" }, label.slice(0, 1) || "?");
  }
  return /* @__PURE__ */ React.createElement("img", { src, alt: "", className: "cc-equip-card-img", draggable: false, onError: () => setBroken(true) });
}
function EquippedSlotIcon({ item, slot }) {
  const [broken, setBroken] = useState(false);
  if (item?.iconPath && !broken) {
    return /* @__PURE__ */ React.createElement("img", { src: apiAsset(item.iconPath), alt: "", className: "cc-slot-img", draggable: false, onError: () => setBroken(true) });
  }
  return /* @__PURE__ */ React.createElement(Icon, { name: SLOT_ICONS[slot] });
}
function EquipmentPopover({ equipment, language, onSlotChange, activeSlot, onClose }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "cc-equip-popover", role: "dialog", "aria-label": slotLabel }, /* @__PURE__ */ React.createElement("div", { className: "cc-equip-popover-head" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("small", null, copy.equipment), /* @__PURE__ */ React.createElement("strong", null, slotLabel)), /* @__PURE__ */ React.createElement("div", { className: "cc-equip-actions" }, selected && /* @__PURE__ */ React.createElement("button", { className: "cc-equip-clear", onClick: () => onSlotChange(activeSlot, null) }, copy.none), /* @__PURE__ */ React.createElement("button", { className: "cc-equip-close", onClick: onClose, title: "Cerrar" }, "x"))), /* @__PURE__ */ React.createElement("div", { className: "cc-equip-list-wrap" }, /* @__PURE__ */ React.createElement(
    "input",
    {
  ...
  ), !catalog && /* @__PURE__ */ React.createElement("div", { className: "cc-equip-loading" }, copy.loading), catalog && /* @__PURE__ */ React.createElement("div", { className: "cc-equip-list" }, filtered.map((it) => {
    ...
    return /* @__PURE__ */ React.createElement(
      "button",
      {
        ...
        title: `${itemName} \xB7 Nv.${it.level}`
      },
      /* @__PURE__ */ React.createElement("span", { className: "cc-equip-card-icon" }, /* @__PURE__ */ React.createElement(EquipmentItemIcon, { item: it, label: itemName })),
      /* @__PURE__ */ React.createElement("span", { className: "cc-equip-item-name" }, itemName),
      /* @__PURE__ */ React.createElement("span", { className: "cc-equip-item-level" }, "Nv.", it.level)
    );
  }), filtered.length === 0 && /* @__PURE__ */ React.createElement("div", { className: "cc-equip-empty" }, copy.noResults))));
}
function CharacterCreator() {
  ...
  const auraEngineRef = useRef(null);
  const auraEngineReadyRef = useRef(false);
  const xpsRendererRef = useRef(null);
  const xpsDataRef = useRef(null);
  const [xpsReady, setXpsReady] = useState(false);
  ...
  useEffect(() => {
    ...
    window.parent?.postMessage({ type: "wakgroup:creator-ready" }, "*");
  ...
  useEffect(() => {
    let cancelled = false;
    fetch(ccAsset("assets/wakfu_default_palettes.json")).then((r) => r.ok ? r.json() : null).then((data) => {
  ...
  useEffect(() => {
    if (!equipPopoverOpen) return void 0;
    const onKeyDown = (event) => {
  ...
  useEffect(() => {
    let cancelled = false;
    fetch(ccAsset("assets/aura_lights_catalog.json")).then((r) => {
  ...
  useEffect(() => {
    ...
    fetch(ccAsset("assets/xps_catalog.json")).then((r) => {
      if (!r.ok) throw new Error(`HTTP ${r.status}`);
      return r.json();
    }).then((data) => {
  ...
  useEffect(() => {
    ...
    engine.load(buildManifest(activeClass, state)).then(() => {
      ...
      const loop = (ts) => {
        ...
        const dt = FRAME_INTERVAL_MS / 1e3;
  ...
  }, [activeClass, state.outfitId, state.hairStyleId, state.sharedCostumeId, state.hideHelmet, state.relicOverlayId, state.gender, state.classId, state.equipment]);
  const syncColors = useCallback(() => {
    ...
    if (!hasCostume) {
      ...
      engine.setColor(SLOT.CLOTHES, null);
    }
  ...
  const activePaletteKey = activeOutfit ? makeOutfitPaletteKey(activeClass.id, state.gender, activeOutfit.id) : null;
  ...
  const activePaletteJson = activePaletteKey ? JSON.stringify({
    ...
    palettes: {
      [activePaletteKey]: activePalette || {
        ...
        outfitLabel: activeOutfit ? repairMojibake(activeOutfit.label) : void 0,
  ...
  const saveActiveOutfitPalette = useCallback(() => {
    ...
    activeClassName,
    activeOutfit,
    activeOutfitAppearanceId,
    activePaletteKey,
    outfitPalettes,
    persistOutfitPalettes,
    state
  ]);
  ...
  useEffect(() => {
    ...
    const outfitDefaults = activePaletteKey ? pngDefaultPalettes.palettes?.[activePaletteKey]?.colors || null : null;
    const patch = {};
  ...
  const importOutfitPalettes = useCallback(() => {
    try {
      ...
      const incoming = Array.isArray(parsed) ? Object.fromEntries(parsed.map((item) => [makeOutfitPaletteKey(item.classId, item.gender, item.outfitId), item])) : parsed.palettes || parsed;
      ...
      for (const [key, entry] of Object.entries(incoming)) {
        ...
        const paletteKey = entry.classId && entry.gender && entry.outfitId ? makeOutfitPaletteKey(entry.classId, entry.gender, entry.outfitId) : key;
  ...
  const selectableSharedCostumes = classSupportsAdvancedCustomization ? SHARED_FEMALE_COSTUMES.filter(
    (item) => item.gender === "unisex" || item.gender === state.gender
  ) : [];
  ...
  const costumeActiveCanals = useMemo(() => {
    if (!activeSharedCostume) return /* @__PURE__ */ new Set([1, 2, 3, 4, 5, 6]);
    const ccSlots = /* @__PURE__ */ new Set();
    for (const comp of activeSharedCostume.components) {
      for (const s of comp.colorSlots || []) {
        if (s >= 10) ccSlots.add(s);
      }
    }
    if (ccSlots.size === 0) return /* @__PURE__ */ new Set();
    const canals = /* @__PURE__ */ new Set();
  ...
  const downloadCharacterPng = useCallback(async () => {
    ...
    const activeAura = currentState.auraLightsId && currentState.auraLightsId !== "none" ? auraCatalogById.get(String(currentState.auraLightsId)) : null;
    const equippedItems = SLOT_ORDER.map((slot) => {
    ...
    const summaryRows = [
      ...
      ["Rotacion", `${Math.round((currentRotation % 360 + 360) % 360)}\xB0`]
    ];
    ...
    const equipmentImages = await Promise.all(equippedItems.map((entry) => loadExportImage(entry.item.iconPath ? apiAsset(entry.item.iconPath) : null)));
    ...
    ctx.fillText(`${activeClassName} \xB7 ${genderLabel(currentState.gender, language)} \xB7 ${activeClassRole}`, 84, 154);
    ...
    try {
      const link = document.createElement("a");
      const safeName = (currentState.name || activeClassName || "wakgroup-personaje").toLowerCase().replace(/[^a-z0-9_-]+/g, "-").replace(/^-+|-+$/g, "") || "wakgroup-personaje";
  ...
  const randomize = () => {
    ...
    const nextSharedCostumes = activeClass.supportsAdvancedCustomization ? SHARED_FEMALE_COSTUMES.filter((item) => item.gender === "unisex" || item.gender === state.gender) : [];
    setState((s) => ({
      ...s,
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "cc-page", "data-screen-label": "01 Creador de personaje" }, /* @__PURE__ */ React.createElement("div", { className: "cc-layout" }, /* @__PURE__ */ React.createElement("div", { className: "cc-panel" }, /* @__PURE__ */ React.createElement("div", { className: "cc-panel-head" }, /* @__PURE__ */ React.createElement("div", { className: "cc-panel-eyebrow" }, /* @__PURE__ */ React.createElement("span", { className: "cc-panel-eyebrow-num" }, "I"), /* @__PURE__ */ React.createElement("span", { className: "cc-panel-eyebrow-label" }, copy.classEyebrow)), /* @__PURE__ */ React.createElement("span", { className: "cc-panel-title" }, copy.classTitle)), /* @__PURE__ */ React.createElement("div", { className: "cc-panel-body" }, /* @__PURE__ */ React.createElement("div", { className: "cc-class-grid" }, CLASSES.map((c) => {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(ClassIcon, { classData: c, gender: state.gender }),
      /* @__PURE__ */ React.createElement("span", { className: "cc-class-name" }, className)
    );
  })))), /* @__PURE__ */ React.createElement("div", { className: "cc-panel cc-panel-center" }, /* @__PURE__ */ React.createElement("div", { className: "cc-panel-head cc-panel-head-center" }, /* @__PURE__ */ React.createElement("div", { className: "cc-panel-heading-main" }, /* @__PURE__ */ React.createElement("div", { className: "cc-panel-eyebrow" }, /* @__PURE__ */ React.createElement("span", { className: "cc-panel-eyebrow-num" }, "II"), /* @__PURE__ */ React.createElement("span", { className: "cc-panel-eyebrow-label" }, copy.avatarEyebrow)), /* @__PURE__ */ React.createElement("span", { className: "cc-panel-title" }, state.name || copy.unnamed, " \xB7 ", activeClassName)), /* @__PURE__ */ React.createElement("div", { className: "cc-panel-toolbar" }, /* @__PURE__ */ React.createElement("button", { className: "btn btn-ghost", onClick: randomize }, /* @__PURE__ */ React.createElement(Icon, { name: "dice", style: { display: "inline-flex", width: 16, height: 16 } }), copy.random), /* @__PURE__ */ React.createElement("button", { className: "btn btn-ghost", onClick: () => setState(DEFAULTS) }, copy.reset), /* @__PURE__ */ React.createElement("button", { className: "btn btn-primary", onClick: downloadCharacterPng }, /* @__PURE__ */ React.createElement(Icon, { name: "save", style: { display: "inline-flex", width: 16, height: 16 } }), copy.savePng))), /* @__PURE__ */ React.createElement("div", { className: "cc-stage" }, /* @__PURE__ */ React.createElement("div", { className: "cc-stage-main" }, /* @__PURE__ */ React.createElement("div", { className: "cc-stage-viewport cc-bg-" + state.bg }, /* @__PURE__ */ React.createElement("div", { className: "cc-stage-runes" }), /* @__PURE__ */ React.createElement("div", { className: "cc-stage-ring" }), /* @__PURE__ */ React.createElement("div", { className: "cc-stage-floor" }), /* @__PURE__ */ React.createElement("div", { className: "cc-stage-meta" }, /* @__PURE__ */ React.createElement("span", { className: "cc-stage-badge" }, /* @__PURE__ */ React.createElement("span", { className: "dot" }), copy.levelHero), /* @__PURE__ */ React.createElement("span", { className: "cc-stage-badge", style: { color: activeClass.accent, borderColor: hexAlpha(activeClass.accent, 0.5) } }, activeClassRole)), /* @__PURE__ */ React.createElement("div", { className: "cc-character-wrap" }, /* @__PURE__ */ React.createElement(
    "canvas",
    {
      ref: canvasRef,
      id: "characterCanvas",
  ...
  )))), /* @__PURE__ */ React.createElement("div", { className: "cc-workbench-grid" }, /* @__PURE__ */ React.createElement("div", { className: "cc-workbench-card cc-workbench-card--wide" }, /* @__PURE__ */ React.createElement("span", { className: "cc-workbench-label" }, copy.summary), /* @__PURE__ */ React.createElement("strong", null, state.name || copy.noNameHero)), /* @__PURE__ */ React.createElement("div", { className: "cc-workbench-card" }, /* @__PURE__ */ React.createElement("span", { className: "cc-workbench-label" }, copy.hair), /* @__PURE__ */ React.createElement("strong", null, activeHair ? repairMojibake(activeHair.label) : copy.classBase)), /* @__PURE__ */ React.createElement("div", { className: "cc-workbench-card" }, /* @__PURE__ */ React.createElement("span", { className: "cc-workbench-label" }, copy.armor), /* @__PURE__ */ React.createElement("strong", null, activeOutfit ? repairMojibake(activeOutfit.label) : copy.classBase)), /* @__PURE__ */ React.createElement("div", { className: "cc-workbench-card" }, /* @__PURE__ */ React.createElement("span", { className: "cc-workbench-label" }, copy.costume), /* @__PURE__ */ React.createElement("strong", null, activeSharedCostume ? repairMojibake(activeSharedCostume.label) : copy.noCostume), /* @__PURE__ */ React.createElement("p", null, activeSharedCostume ? repairMojibake(activeSharedCostume.sourceLabel) : activeOutfit ? copy.baseClothes : copy.liveBase)), /* @__PURE__ */ React.createElement("div", { className: "cc-workbench-card cc-workbench-card--palette" }, /* @__PURE__ */ React.createElement("span", { className: "cc-workbench-label" }, copy.activePalette), /* @__PURE__ */ React.createElement("div", { className: "cc-palette-row" }, [state.skinColor, state.hairColor, state.eyeColor, state.costume1, state.costume2, state.costume5].map((color, index) => /* @__PURE__ */ React.createElement("span", { key: `${color}-${index}`, className: "cc-palette-dot", style: { background: color } })))))))), /* @__PURE__ */ React.createElement("div", { className: "cc-panel" }, /* @__PURE__ */ React.createElement("div", { className: "cc-panel-head" }, /* @__PURE__ */ React.createElement("div", { className: "cc-panel-eyebrow" }, /* @__PURE__ */ React.createElement("span", { className: "cc-panel-eyebrow-num" }, "III"), /* @__PURE__ */ React.createElement("span", { className: "cc-panel-eyebrow-label" }, copy.appearance)), /* @__PURE__ */ React.createElement("span", { className: "cc-panel-title" }, copy.customize)), /* @__PURE__ */ React.createElement("div", { className: "cc-panel-body" }, /* @__PURE__ */ React.createElement("div", { className: "cc-panel-quick-summary" }, /* @__PURE__ */ React.createElement("span", { className: "cc-quick-chip" }, activeClassName), /* @__PURE__ */ React.createElement("span", { className: "cc-quick-chip" }, genderLabel(state.gender, language)), /* @__PURE__ */ React.createElement("span", { className: "cc-quick-chip" }, activeOutfit ? repairMojibake(activeOutfit.label) : copy.classBase), /* @__PURE__ */ React.createElement("span", { className: "cc-quick-chip" }, activeSharedCostume ? repairMojibake(activeSharedCostume.label) : copy.noCostume)), /* @__PURE__ */ React.createElement("div", { className: "cc-section" + (openSection === "identity" ? " is-open" : "") }, /* @__PURE__ */ React.createElement("button", { type: "button", className: "cc-section-head cc-section-toggle", onClick: () => toggleSection("identity") }, /* @__PURE__ */ React.createElement("span", { className: "cc-section-title" }, /* @__PURE__ */ React.createElement(Icon, { name: "user" }), " ", copy.identity), /* @__PURE__ */ React.createElement("span", { className: "cc-section-caret" }, openSection === "identity" ? "\u2212" : "+")), openSection === "identity" && /* @__PURE__ */ React.createElement("div", { className: "cc-field-group" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "cc-input-label" }, copy.heroName), /* @__PURE__ */ React.createElement(
    "input",
    {
      className: "cc-input",
      type: "text",
  ...
  )), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "cc-input-label" }, copy.gender), /* @__PURE__ */ React.createElement("div", { className: "cc-segmented" }, /* @__PURE__ */ React.createElement(
    "button",
    {
      className: "cc-seg-btn" + (state.gender === "female" ? " active" : ""),
      onClick: () => {
        set({ gender: "female", sharedCostumeId: "none" });
      }
    },
    "\u2640 ",
    copy.female
    ...
    "button",
    {
      ...
      onClick: () => {
        set({ gender: "male", sharedCostumeId: "none" });
      }
    },
    "\u2642 ",
    copy.male
  ))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "cc-input-label" }, copy.animation), /* @__PURE__ */ React.createElement("div", { className: "cc-anim-tabs" }, [
    { cat: "move", label: copy.movement },
    { cat: "female", label: genderLabel(state.gender, language) },
    { cat: "weapon", label: copy.weapons }
  ].map(({ cat, label }) => /* @__PURE__ */ React.createElement(
    "button",
    {
      key: cat,
    ...
    label
  ))), /* @__PURE__ */ React.createElement("div", { className: "cc-anim-grid" }, ANIMATIONS.filter((a) => a.cat === state.animCat).map((a) => /* @__PURE__ */ React.createElement(
    "button",
    {
      key: a.id,
    ...
    animLabel(a, language)
  )))))), /* @__PURE__ */ React.createElement("div", { className: "cc-section" + (openSection === "face" ? " is-open" : "") }, /* @__PURE__ */ React.createElement("button", { type: "button", className: "cc-section-head cc-section-toggle", onClick: () => toggleSection("face") }, /* @__PURE__ */ React.createElement("span", { className: "cc-section-title" }, /* @__PURE__ */ React.createElement(Icon, { name: "face" }), " ", copy.face), /* @__PURE__ */ React.createElement("span", { className: "cc-section-caret" }, openSection === "face" ? "\u2212" : "+")), openSection === "face" && /* @__PURE__ */ React.createElement("div", { className: "cc-field-group" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "cc-input-label" }, copy.skinTone), /* @__PURE__ */ React.createElement(HexPicker, { value: state.skinColor, onChange: (v) => set({ skinColor: v }) })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "cc-input-label" }, copy.eyeColor), /* @__PURE__ */ React.createElement(HexPicker, { value: state.eyeColor, onChange: (v) => set({ eyeColor: v }) })))), /* @__PURE__ */ React.createElement("div", { className: "cc-section" + (openSection === "hair" ? " is-open" : "") }, /* @__PURE__ */ React.createElement("button", { type: "button", className: "cc-section-head cc-section-toggle", onClick: () => toggleSection("hair") }, /* @__PURE__ */ React.createElement("span", { className: "cc-section-title" }, /* @__PURE__ */ React.createElement(Icon, { name: "palette" }), " ", copy.hair), /* @__PURE__ */ React.createElement("span", { className: "cc-section-caret" }, openSection === "hair" ? "\u2212" : "+")), openSection === "hair" && /* @__PURE__ */ React.createElement("div", { className: "cc-field-group" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "cc-input-label" }, copy.hair), classSupportsAdvancedCustomization ? /* @__PURE__ */ React.createElement("div", { className: "cc-style-grid cc-style-grid--hair" }, availableHairStyles.map((h) => /* @__PURE__ */ React.createElement(
    "button",
    {
      key: h.id,
      type: "button",
    ...
    /* @__PURE__ */ React.createElement("span", { className: "cc-style-icon" }, "\u2726"),
    /* @__PURE__ */ React.createElement("span", { className: "cc-style-name" }, repairMojibake(h.label))
  ))) : /* @__PURE__ */ React.createElement("div", { className: "cc-inline-note" }, copy.realBaseNoHair)), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "cc-input-label" }, copy.hairColor), /* @__PURE__ */ React.createElement(HexPicker, { value: state.hairColor, onChange: (v) => set({ hairColor: v }) })))), /* @__PURE__ */ React.createElement("div", { className: "cc-section" + (openSection === "wardrobe" ? " is-open" : "") }, /* @__PURE__ */ React.createElement("button", { type: "button", className: "cc-section-head cc-section-toggle", onClick: () => toggleSection("wardrobe") }, /* @__PURE__ */ React.createElement("span", { className: "cc-section-title" }, /* @__PURE__ */ React.createElement(Icon, { name: "cape" }), " ", copy.wardrobe), /* @__PURE__ */ React.createElement("span", { className: "cc-section-caret" }, openSection === "wardrobe" ? "\u2212" : "+")), openSection === "wardrobe" && /* @__PURE__ */ React.createElement("div", { className: "cc-field-group" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "cc-input-label" }, copy.armorModel), availableOutfits.length > 0 ? /* @__PURE__ */ React.createElement("div", { className: "cc-style-grid cc-style-grid--outfits" }, availableOutfits.map((o) => /* @__PURE__ */ React.createElement(
    "button",
    {
      key: o.id,
      type: "button",
    ...
    /* @__PURE__ */ React.createElement("span", { className: "cc-style-icon" }, "\u2694"),
    /* @__PURE__ */ React.createElement("span", { className: "cc-style-name" }, repairMojibake(o.label))
  ))) : /* @__PURE__ */ React.createElement("div", { className: "cc-inline-note" }, copy.noOutfits)), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "cc-input-label" }, copy.costume), /* @__PURE__ */ React.createElement("div", { className: "cc-wardrobe-summary" }, /* @__PURE__ */ React.createElement("div", { className: "cc-wardrobe-pill" }, /* @__PURE__ */ React.createElement("span", { className: "cc-wardrobe-pill-label" }, copy.costume), /* @__PURE__ */ React.createElement("strong", null, activeSharedCostume ? repairMojibake(activeSharedCostume.label) : copy.noCostume)), /* @__PURE__ */ React.createElement("div", { className: "cc-wardrobe-pill" }, /* @__PURE__ */ React.createElement("span", { className: "cc-wardrobe-pill-label" }, copy.available), /* @__PURE__ */ React.createElement("strong", null, classSupportsAdvancedCustomization ? selectableSharedCostumes.length : 0, " ", copy.costume.toLowerCase())), /* @__PURE__ */ React.createElement("div", { className: "cc-wardrobe-pill" }, /* @__PURE__ */ React.createElement("span", { className: "cc-wardrobe-pill-label" }, copy.status), /* @__PURE__ */ React.createElement("strong", null, state.hideHelmet && activeSharedCostume ? copy.noHelmet : copy.fullView))), /* @__PURE__ */ React.createElement("div", { className: "cc-wardrobe-actions" }, /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
    ...
    copy.openWardrobe
  ), classSupportsAdvancedCustomization && activeSharedCostume && /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
    ...
    state.hideHelmet ? copy.noHelmet : copy.withHelmet
  ), state.sharedCostumeId !== "none" && /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
    ...
    copy.removeCostume
  )), !classSupportsAdvancedCustomization && /* @__PURE__ */ React.createElement("div", { className: "cc-inline-note" }, copy.noAdvancedWardrobe), activeSharedCostume && /* @__PURE__ */ React.createElement("div", { className: "cc-shared-costume-meta" }, /* @__PURE__ */ React.createElement("strong", null, repairMojibake(activeSharedCostume.sourceLabel || activeSharedCostume.label)), /* @__PURE__ */ React.createElement("span", null, activeSharedCostume.components.length, " ", activeSharedCostume.components.length !== 1 ? copy.components : copy.component, activeSharedCostume.itemId ? ` \xB7 item #${activeSharedCostume.itemId}` : ` \xB7 ${activeSharedCostume.components[0]?.appearanceId}`))), [
    ...
    const active = costumeActiveCanals.size === 0 ? false : costumeActiveCanals.has(canal);
    ...
    return /* @__PURE__ */ React.createElement(
      "div",
      {
        ...
        title: inactive ? copy.noEffectTitle : void 0
      },
      /* @__PURE__ */ React.createElement("label", { className: "cc-input-label" }, label, inactive && /* @__PURE__ */ React.createElement("span", { className: "cc-canal-badge" }, copy.noEffect)),
      /* @__PURE__ */ React.createElement(HexPicker, { value: state[key], onChange: (v) => set({ [key]: v }) })
    );
  }))), false && /* @__PURE__ */ React.createElement("div", { className: "cc-section" + (openSection === "auras" ? " is-open" : "") }, /* @__PURE__ */ React.createElement("button", { type: "button", className: "cc-section-head cc-section-toggle", onClick: () => toggleSection("auras") }, /* @__PURE__ */ React.createElement("span", { className: "cc-section-title" }, /* @__PURE__ */ React.createElement(Icon, { name: "sparkles" }), " ", copy.auras), /* @__PURE__ */ React.createElement("span", { className: "cc-section-caret" }, openSection === "auras" ? "\u2212" : "+")), openSection === "auras" && auraCatalog.length > 0 && (() => {
    const equip = auraCatalog.filter((a) => a.type === "equipment_aura");
    const AuraCard = ({ aura }) => /* @__PURE__ */ React.createElement(
      "button",
      {
        key: aura.id,
        type: "button",
      ...
      /* @__PURE__ */ React.createElement("span", { className: "cc-aura-label" }, repairMojibake(aura.name))
    );
    return /* @__PURE__ */ React.createElement("div", { className: "cc-field-group" }, /* @__PURE__ */ React.createElement("label", { className: "cc-input-label" }, copy.equipmentAuras, /* @__PURE__ */ React.createElement("span", { className: "cc-input-label-sub" }, " \xB7 ", equip.length)), /* @__PURE__ */ React.createElement("div", { className: "cc-aura-grid" }, /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
      ...
      /* @__PURE__ */ React.createElement("span", { className: "cc-aura-no-icon" }, "\xD7"),
      /* @__PURE__ */ React.createElement("span", { className: "cc-aura-label" }, copy.noAura)
    ), equip.map((a) => /* @__PURE__ */ React.createElement(AuraCard, { key: a.id, aura: a }))));
  })()), /* @__PURE__ */ React.createElement("div", { className: "cc-cta-row" }, saveStatus && /* @__PURE__ */ React.createElement("span", { className: "cc-save-status" }, saveStatus), /* @__PURE__ */ React.createElement("button", { className: "btn btn-primary", onClick: saveToWakGroup }, copy.saveAppearance))))), wardrobeOpen && /* @__PURE__ */ React.createElement("div", { className: "cc-modal-backdrop", onClick: () => setWardrobeOpen(false) }, /* @__PURE__ */ React.createElement(
    "div",
    {
    ...
    /* @__PURE__ */ React.createElement("div", { className: "cc-modal-head" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "cc-panel-eyebrow-label" }, copy.wardrobeModal), /* @__PURE__ */ React.createElement("h3", { className: "cc-modal-title" }, copy.wardrobeOf, " ", activeClassName)), /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
    ...
    /* @__PURE__ */ React.createElement("div", { className: "cc-modal-body" }, classSupportsAdvancedCustomization && /* @__PURE__ */ React.createElement("div", { className: "cc-modal-section" }, /* @__PURE__ */ React.createElement("label", { className: "cc-input-label" }, copy.costume, /* @__PURE__ */ React.createElement("span", { className: "cc-input-label-sub" }, " \xB7 ", SHARED_FEMALE_COSTUMES.length, " ", copy.catalog, " \xB7 ", selectableSharedCostumes.length, " ", copy.available.toLowerCase())), /* @__PURE__ */ React.createElement("div", { className: "cc-costume-search-row" }, /* @__PURE__ */ React.createElement(
      "input",
      {
    ...
    ), activeSharedCostume && /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
        className: "cc-seg-btn cc-costume-filter-btn" + (state.hideHelmet ? " active" : ""),
      ...
      state.hideHelmet ? copy.noHelmet : copy.withHelmet
    )), /* @__PURE__ */ React.createElement("div", { className: "cc-costume-grid cc-costume-grid--modal" }, /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
      ...
      /* @__PURE__ */ React.createElement("span", { className: "cc-costume-no-icon" }, "\xD7"),
      /* @__PURE__ */ React.createElement("span", { className: "cc-costume-name" }, copy.noCostume)
    ), filteredCostumes.map((costume) => {
      const appId = costume.components?.[0]?.appearanceId;
      const iconSrc = appId ? ccAsset(`assets/costume_icons/${appId}.png`) : null;
      const itemIconSrc = costume.iconPath ? apiAsset(costume.iconPath) : null;
      const fallbackSrc = itemIconSrc || costume.previewPath || apiAsset('/assets/items/51317870.png');
      const src = iconSrc || fallbackSrc;
      ...
      return /* @__PURE__ */ React.createElement(
        ...
        src ? /* @__PURE__ */ React.createElement(
          "img",
          {
            ...
            loading: "lazy",
            decoding: "async",
            onError: fallbackSrc && iconSrc ? ((e) => {
              if (e.target.src !== fallbackSrc) e.target.src = fallbackSrc;
            }) : void 0
          }
        ) : /* @__PURE__ */ React.createElement("span", { className: "cc-costume-no-icon" }, costume.id.replace("cp_", "").slice(0, 5)),
        /* @__PURE__ */ React.createElement("span", { className: "cc-costume-name" }, costumeLabel)
      );
    }))))
  )), betaModalOpen && /* @__PURE__ */ React.createElement("div", { className: "cc-modal-backdrop", onClick: closeBeta }, /* @__PURE__ */ React.createElement("div", { className: "cc-modal cc-modal--beta", role: "dialog", "aria-modal": "true", onClick: (e) => e.stopPropagation() }, /* @__PURE__ */ React.createElement("div", { className: "cc-modal-head" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "cc-panel-eyebrow-label cc-beta-eyebrow" }, "BETA"), /* @__PURE__ */ React.createElement("h3", { className: "cc-modal-title" }, copy.betaTitle))), /* @__PURE__ */ React.createElement("div", { className: "cc-modal-body" }, /* @__PURE__ */ React.createElement("p", { className: "cc-beta-intro" }, copy.betaIntro), /* @__PURE__ */ React.createElement("ul", { className: "cc-beta-list" }, /* @__PURE__ */ React.createElement("li", null, copy.betaItem1), /* @__PURE__ */ React.createElement("li", null, copy.betaItem2), /* @__PURE__ */ React.createElement("li", null, copy.betaItem3), /* @__PURE__ */ React.createElement("li", null, copy.betaItem4), /* @__PURE__ */ React.createElement("li", null, copy.betaItem5)), /* @__PURE__ */ React.createElement("p", { className: "cc-beta-feedback" }, copy.betaFeedback), /* @__PURE__ */ React.createElement("div", { className: "cc-beta-actions" }, /* @__PURE__ */ React.createElement("button", { type: "button", className: "btn btn-primary", onClick: closeBeta }, copy.betaStart))))), /* @__PURE__ */ React.createElement("div", { className: "cc-loadout" }, /* @__PURE__ */ React.createElement("div", { className: "cc-loadout-label" }, /* @__PURE__ */ React.createElement("small", null, copy.equipment), /* @__PURE__ */ React.createElement("strong", null, copy.visual)), /* @__PURE__ */ React.createElement("div", { className: "cc-loadout-slots" }, SLOT_ORDER.map((slot) => {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(EquippedSlotIcon, { item: equipped, slot }),
      /* @__PURE__ */ React.createElement("span", { className: "cc-slot-name" }, slotLabel.split(" ")[0])
    );
  })), equipPopoverOpen && /* @__PURE__ */ React.createElement(
    EquipmentPopover,
    {
...
ReactDOM.createRoot(document.getElementById("root")).render(/* @__PURE__ */ React.createElement(CharacterCreator, null));
